...
public static class FallbackEmitter
{
    ...
    private static void EmitMethod(StringBuilder sb, RepositoryModel repo, MethodModel method)
    {
        ...
        switch (strategy)
        {
            ...
            case FallbackStrategy.LocalOnly:
                ...
                break;
            case FallbackStrategy.WriteThrough:
    ...
    private static FallbackStrategy DetermineStrategy(MethodModel method)
    {
        ...
        if (method.OperationOverride == Models.OperationOverride.Mutation)
        {
            ...
            {
                Models.MutationTargetMode.Api  => FallbackStrategy.ApiOnly,
                Models.MutationTargetMode.Both => FallbackStrategy.WriteThrough,
                _ => FallbackStrategy.LocalOnly
            };
        }
